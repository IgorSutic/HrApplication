import React, { useMemo, createContext, useContext, useState, useCallback, useEffect, useReducer } from 'react';
...
var LinkComponentContext = createContext(null);
var CalendarSettingsContext = createContext({});
...
function Cell(_a) {
    ...
    return React.createElement(React.Fragment, null, events.sort(function (a, b) {
        ...
        return React.createElement(React.Fragment, { key: 'cell.' + i },
            React.createElement("div", { className: classnames(styles.event, (_a = {},
    ...
    return (React.createElement("table", { className: styles.table },
        ...
        React.createElement("tbody", null, weeks.map(function (week, i) {
            ...
            for (var i_1 = 0; i_1 < 7; i_1++) {
                ...
                var day = (React.createElement("td", { id: timestamp.toString(), key: timestamp.toString(), className: classnames(styles.cell, (_a = {},
...
function Calendar(props) {
    ...
    return (React.createElement(Contexts, { values: [
        ...
        React.createElement(CalendarKey, { colorNames: 'events' in props ? props.calendars : colors, colorStatuses: colorStatuses, updateColorStatuses: toggleColor, classNames: props.classNames }),
