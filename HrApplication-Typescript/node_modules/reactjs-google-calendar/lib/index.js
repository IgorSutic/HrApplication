...
function CalendarKey(props) {
    ...
    return (React__default.createElement("div", { className: styles.key }, sorted.map(function (_a, i) {
        var color = _a[0], calendarName = _a[1];
        return React__default.createElement("div", { className: styles.key, key: ['keyElement', i].join('.') },
            React__default.createElement("span", { className: styles.status, onClick: function () { return props.updateColorStatuses(color); }, style: { color: color } }, colorStatuses[color] ?
                '\u2b24' :
                '\u2b58'),
            React__default.createElement("h4", null, '\u200b ' + calendarName));
    })));
}
...
function Contexts(_a) {
    ...
    return values.reduce(function (acc, _a) {
        ...
        return (React__default.createElement(context.Provider, { value: value }, acc));
    }, children);
}
var LinkComponentContext = React.createContext(null);
var CalendarSettingsContext = React.createContext({});

function Cell(_a) {
    var maxEvents = _a.maxEvents, styles = _a.styles, events = _a.events, colorStatuses = _a.colorStatuses, colorNames = _a.colorNames;
    var Link = React.useContext(LinkComponentContext);
    var _b = React.useState(false), isExpanded = _b[0], expand = _b[1];
    return React__default.createElement(React__default.Fragment, null, events.sort(function (a, b) {
        ...
        if (i === maxEvents && !isExpanded) {
            return React__default.createElement("div", { key: 'overflowMessage', className: styles.overflowMessage, onClick: function () { return expand(true); } },
                React__default.createElement("h4", null,
                    React__default.createElement(fa.FaPlusCircle, null),
                    arr.length - maxEvents,
                    " more"));
        }
        if (i > maxEvents && !isExpanded)
            return null;
        return React__default.createElement(React__default.Fragment, { key: 'cell.' + i },
            React__default.createElement("div", { className: classnames(styles.event, (_a = {},
                    _a[styles.hidden] = !colorStatuses[event.color],
                    _a)) },
                React__default.createElement("div", { className: styles.eventHeader },
                    React__default.createElement("h4", { className: styles.eventName },
                        React__default.createElement("span", { className: styles.status, title: colorNames[event.color], style: {
                                color: event.color
                            } }, "\u2B24"),
                        React__default.createElement("span", { className: 'toolTip' }),
                        event.facebookEvent || event.link ?
                            Link ?
                                React__default.createElement(Link, { className: styles.eventTitle, href: event.facebookEvent || event.link }, event.title) :
                                React__default.createElement("a", { className: styles.eventTitle, href: event.facebookEvent || event.link }, event.title) :
                            event.title)),
                React__default.createElement("div", null,
                    React__default.createElement("h5", null,
                        getDisplayTime(event.start),
                        ' ',
                        event.map ?
                            Link ?
                                React__default.createElement(Link, { href: event.map }, event.location) :
                                React__default.createElement("a", { href: event.map, rel: 'noopener noreferrer', target: '_blank' }, event.location)
                            : event.location,
                        React__default.createElement("br", null),
                        event.description || null))),
            (i === arr.length - 1) && isExpanded ?
                React__default.createElement("div", { className: styles.overflowMessage, onClick: function () { return expand(false); } },
                    React__default.createElement("h4", null,
                        React__default.createElement(fa.FaMinusCircle, null),
                        "Show less")) :
                null);
    }));
}
...
function CalendarFrame(props) {
    ...
    var colorStatuses = props.colorStatuses || {};
    return (React__default.createElement("table", { className: styles.table },
        React__default.createElement("thead", null,
            React__default.createElement("tr", null, __spreadArray([props.title], days).map(function (day, i) {
                return React__default.createElement("th", { scope: 'column', key: day, className: i ? '' : styles.firstColumn }, day);
            }))),
        React__default.createElement("tbody", null, weeks.map(function (week, i) {
            var _a;
            var days = [];
            for (var i_1 = 0; i_1 < 7; i_1++) {
                ...
                var day = (React__default.createElement("td", { id: timestamp.toString(), key: timestamp.toString(), className: classnames(styles.cell, (_a = {},
                        _a[styles.today || ''] = props.noHighlightToday !== false && today,
                        _a)) },
                    React__default.createElement("div", null, props.events[timestamp] && !Object.values(props.events[timestamp]).every(function (e) { return !colorStatuses[e.color]; }) ?
                        React__default.createElement(Cell, __assign({ key: [timestamp, i_1].join('.'), colorNames: props.colorNames, events: props.events[timestamp] }, { maxEvents: maxEvents, styles: styles, timestamp: timestamp, colorStatuses: colorStatuses })) :
                        React__default.createElement("div", { className: styles.dateNumber }, date.getDate()))));
                days.push(day);
            }
            return React__default.createElement("tr", { key: 'week.' + i },
                React__default.createElement("th", { scope: 'row', className: styles.firstColumn }, week.toDateString().slice(4, 10)),
                days);
        }))));
}
...
var _where = "/media/lazy/OS/Users/lazyst/Files/react-google-calendar";
var author = {
	name: "Matt Zabriskie"
};
var browser$1 = {
...
function useEvents(props) {
    var _this = this;
    var _a = React.useState(props.events || {}), events = _a[0], setEvents = _a[1];
    var _b = React.useState({}), colors = _b[0], setColors = _b[1]; /* calendarName */
    var settings = React.useContext(CalendarSettingsContext);
    var handleId = React.useCallback(function (calendarId) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var parseColorsFromEvents = React.useCallback(function (eventDict) {
        var c = colors;
...
function Calendar(props) {
    ...
    var _b = React.useReducer(function (state, action) {
        if (typeof action === 'string') {
            ...
            return action.reduce(function (acc, curr) {
                acc[curr] = true;
                return acc;
            }, {});
        }
    }, {}), colorStatuses = _b[0], toggleColor = _b[1];
    var calendars = React.useMemo(function () {
        if ('events' in props) {
    ...
    return (React__default.createElement(Contexts, { values: [
            [CalendarSettingsContext, props.settings || { locationReplacers: {} }],
            [LinkComponentContext, props.customLinkComponent || null]
        ] },
        React__default.createElement(CalendarKey, { colorNames: 'events' in props ? props.calendars : colors, colorStatuses: colorStatuses, updateColorStatuses: toggleColor, classNames: props.classNames }),
        React__default.createElement(CalendarFrame, __assign({}, { events: events, colorStatuses: colorStatuses }, props, { maxEvents: 3, colorNames: 'events' in props ? props.calendars : colors }))));
}
